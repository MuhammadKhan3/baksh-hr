  ...
  if(role==='admin'){
    return (
        ...
        <Box className={classes.listContainer} component='div'>
            <List className={classes.menuList}>
                ...
                <DownMenu label={"Leaves"} droplabel={[{label:"Add Leave",path:'/add-leave'},{label:"Manage Leave",path:'/manage-leave'}]} icon={leave} classes={classes} downArrow={downArrow} tab={tab} settab={settab} />
                <DownMenu label={"Payroll"} droplabel={[{label:"Payscale",path:'/payscale'},{label:"Monthly",path:'/monthly'}]} icon={payroll} classes={classes} downArrow={downArrow}  tab={tab} settab={settab}/>
    ...
    return (
        ...
        <Box className={classes.listContainer} component='div'>
            <List className={classes.menuList}>
            <DownMenu label={"Dashboard"} icon={Dashboard} path={'/dashboard'} classes={classes}/>
            <DownMenu label={"My Account"} droplabel={[{label:"Profile",path:'/add-employee'},{label:"Leave",path:'/manage-employees'}]} icon={employee} classes={classes} downArrow={downArrow} tab={tab} settab={settab}/>
            {/* <DownMenu label={"Attendance"} droplabel={[{label:"Daily Attendance",path:'/Daily-attendance'},{label:"Attendance Report",path:'/attendance-report'},{label:"Manage Attendance",path:'/manage-attendance'}]} icon={attendance} classes={classes} downArrow={downArrow} tab={tab} settab={settab}/>
            <DownMenu label={"Loan Management"} icon={loan} classes={classes} downArrow={downArrow}/>
    ...
    return (
        ...
        <Box className={classes.listContainer} component='div'>
            <List className={classes.menuList}>
            <DownMenu label={"Dashboard"} icon={Dashboard} path={'/dashboard'} classes={classes}/>
             <DownMenu label={"Employees"} droplabel={[{label:"Manage Employee",path:'/manage-emplyoyee'}]} icon={employee} classes={classes} downArrow={downArrow} tab={tab} settab={settab}/>
            {/* <DownMenu label={"Attendance"} droplabel={[{label:"Daily Attendance",path:'/Daily-attendance'},{label:"Attendance Report",path:'/attendance-report'},{label:"Manage Attendance",path:'/manage-attendance'}]} icon={attendance} classes={classes} downArrow={downArrow} tab={tab} settab={settab}/>
            <DownMenu label={"Loan Management"} icon={loan} classes={classes} downArrow={downArrow}/>
            <DownMenu label={"Leaves"} icon={leave} classes={classes} downArrow={downArrow}/>
            <DownMenu label={"Payroll"} icon={payroll} classes={classes} downArrow={downArrow}/>
