...
const rows = [
  ...
  { id: 2, name: 'muhammad', email: "muhammad327@gmail.com",department:'Human',designation:'hr',status:'active' },
  { id: 3, name: 'zain', email: "zain327@gmail.com",department:'marketing',designation:'manager',status:'inactive' },
  { id: 4, name: 'jabbarkhan', email: "jabbar327@gmail.com",department:'marketing',designation:'manager',status:'inactive' },
  { id: 5, name: 'ahmaddf', email: "ahmad3273344@gmail.com",department:'marketing',designation:'manager',status:'inactive' },
  { id: 6, name: 'ahmad', email: "ahmad327@gmail.com",department:'marketing',designation:'manager',status:'active' },
  { id: 7, name: 'muhammad', email: "muhammad327@gmail.com",department:'Human',designation:'hr',status:'active' },
  { id: 8, name: 'zain', email: "zain327@gmail.com",department:'marketing',designation:'manager',status:'inactive' },
  { id: 9, name: 'jabbarkhan', email: "jabbar327@gmail.com",department:'marketing',designation:'manager',status:'inactive' },
  { id: 10, name: 'ahmaddf', email: "ahmad3273344@gmail.com",department:'marketing',designation:'manager',status:'inactive' },
];
...
const columns = [
  ...
  { id: 'officeCode', label: 'Office Code' },
...
const ManagerTable = ({employees,setemployees,search,handleOpen,setDelete}) => {
  ...
  useEffect(()=>{
    const fetchManager=async ()=>{
      ...
      const response=await axios.post(adminApi+`/get-managers?search=${search}`,{page:''},{
        headers:{
                    ...
                    <TableCell className={`${classes.tableCell} ${classes.depdisContainer}`}>
                     ...
                     <TableCell className={classes.tableCell}>
                        <Box className={classes.actionContainer}>
                          ...
                          <NavLink to={`/edit-manager/${row.id}`}>
