...
const statusIcon = (status) => {
  switch (status) {
    case "Present":
      return (
        <Chip
          icon={<FiberManualRecord style={{ color: "green" }} />}
          label="Present"
          variant="outlined"
        />
      );
    ...
    case "Absent":
      return (
        <Chip
          icon={<FiberManualRecord style={{ color: "red" }} />}
          label="Absent"
          variant="outlined"
        />
      );
    case "None":
      return (
        <Chip icon={<FiberManualRecord />} label="None" variant="outlined" />
      );
    default:
      return null;
  }
        ...
        <Table stickyHeader>
          <TableHead>
            <TableRow>
              ...
              <TableCell style={{ width: "0vw" }} align="center">
                Check in
              </TableCell>
              <TableCell style={{ width: "0vw" }} align="center">
                Check out
          ...
          <TableBody>
            {rows.map((row) => (
              <TableRow key={row.id}>
                ...
                <TableCell align="center">
                  <Button size="small" className={classes.presentBtn}>
                    P
                  </Button>
                  <Button size="small" className={classes.absentBtn}>
                    A
                  </Button>
                  <Button
                    id="fade-button"
